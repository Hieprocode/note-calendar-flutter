              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return AppSlidable(
                    ...
                    onEdit: () {
                      // MỞ FORM SỬA – DÙNG AddCustomerView NHƯ LÀ FORM CHUNG
                    ...
                    child: Card(
                      ...
                      child: ListTile(
                        ...
                        trailing: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Text("${customer.totalBookings}", style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 26, color: Colors.green)),
                            const Text("lịch hẹn", style: TextStyle(fontSize: 13, color: Colors.grey)),
                          ],
                        ),
                      ),
                    ),
